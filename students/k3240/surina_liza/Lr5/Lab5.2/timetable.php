...
$result = $pdo->query('SELECT * FROM hotel.timetable
                       ORDER BY id_timetable');
$table = "hotel.timetable";
?>
			...
			<div class="row">
				...
				<div class="col mt-1">
					...
					<form method="post">
						...
						<div class="form-group"><input type="text" class="form-control" name="weekday" placeholder="weekday "></div>
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
         ...
         if (isset($_POST["del_btn"])) {
             $result = $pdo->query("DELETE from $table where id_timetable='$_POST[id]'");
         }

         if (isset($_POST["add_btn"])) {
             $result = $pdo->query("INSERT INTO  $table (id_timetable, number_code, id_service, weekday) values (
            '$_POST[id_timetable]',
            '$_POST[number_code]',
            '$_POST[id_service]',
            '$_POST[weekday]')");
