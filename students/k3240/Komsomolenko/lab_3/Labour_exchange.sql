...
-- DROP TABLE l_e."Applicant";

CREATE TABLE l_e."Applicant"
(
...
ALTER TABLE l_e."Applicant"
    OWNER to postgres;

--Создание таблицы бюро
-- Table: l_e."Bureau"

-- DROP TABLE l_e."Bureau";

CREATE TABLE l_e."Bureau"
(
    ...
    CONSTRAINT "Bureau_FCS_employer_fkey" FOREIGN KEY ("FCS_employer")
        REFERENCES l_e."Employers" ("FCS_employer") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT "Bureau_ID_course_fkey" FOREIGN KEY ("ID_course")
        REFERENCES l_e."Course" ("ID_course") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT "Bureau_ID_directory_fkey" FOREIGN KEY ("ID_directory")
        REFERENCES l_e."Directory_professions" ("ID_directory") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT "Bureau_ID_employer_fkey" FOREIGN KEY ("ID_employer")
        REFERENCES l_e."Employers" ("ID_employer") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT "Bureau_ID_job_openings_fkey" FOREIGN KEY ("ID_job_openings")
        REFERENCES l_e."Job_openings" ("ID_job_openings") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID
)
...
(
    ...
    CONSTRAINT "CV_FCS_applicant_fkey" FOREIGN KEY ("FCS_applicant")
        REFERENCES l_e."Applicant" ("FCS_applicant") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    ...
    CONSTRAINT "CV_ID_applicant_fkey" FOREIGN KEY ("ID_applicant")
        REFERENCES l_e."Applicant" ("ID_applicant") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
...
-- DROP TABLE l_e."Course";

CREATE TABLE l_e."Course"
(
...
ALTER TABLE l_e."Course"
    OWNER to postgres;

--Создание таблицы справочник профессий
-- Table: l_e."Directory_professions"

-- DROP TABLE l_e."Directory_professions";

CREATE TABLE l_e."Directory_professions"
(
...
ALTER TABLE l_e."Directory_professions"
    OWNER to postgres;

--Создание таблицы работодатели
-- Table: l_e."Employers"

-- DROP TABLE l_e."Employers";

CREATE TABLE l_e."Employers"
(
...
ALTER TABLE l_e."Employers"
    OWNER to postgres;

--Создание таблицы вакансии
-- Table: l_e."Job_openings"

-- DROP TABLE l_e."Job_openings";

CREATE TABLE l_e."Job_openings"
(
...
ALTER TABLE l_e."Job_openings"
    OWNER to postgres;

--Создание таблицы учебный центр
-- Table: l_e."Training_center"

-- DROP TABLE l_e."Training_center";

CREATE TABLE l_e."Training_center"
(
...
ALTER TABLE l_e."Training_center"
    OWNER to postgres;


-- Заполнение таблиц
--Таблица соискатель
INSERT INTO l_e."Applicant"(
...
INSERT INTO l_e."Directory_professions"(
...
INSERT INTO l_e."Training_center"(
