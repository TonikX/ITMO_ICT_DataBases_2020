...
$result = $pdo->query('SELECT * FROM public.workers
                       ORDER BY id');
		...
		<div class="container"><p></p>
			<div class="row">
				...
				<div class="col mt-1">
					<h2>workers</h2>
					<p></p>
					<form class="form-row" method="post" action="workers.php">
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
         ...
         if (isset($_POST["add_btn"])) {
             $result = $pdo->query("INSERT INTO  $table (id, surname, firstname) values (
            '$_POST[id]',
			'$_POST[surname]',
            '$_POST[firstname]')");
         }
