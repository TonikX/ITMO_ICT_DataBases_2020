...
CREATE TABLE "Bargain"."Consignment" (
    ...
    "Consignment_delivery_conditions" text NOT NULL,
...
COPY "Bargain"."Deal" ("ID_deal", "FK_ID_broker", "FK_ID_Consignment", "Deal_date", "Transaction_amount") FROM stdin;
...
COPY "Bargain"."Consignment" ("ID_Consignment", "Consignment_delivery_conditions", "FK_ID_product") FROM stdin;
1   Prepayment  1
2   Prepayment  2
3   No_Prepayment  3
4   Prepayment  4
...
COPY "Bargain"."Broker" ("ID_broker", "Broker_salary", "FK_Bureau_name") FROM stdin;
1	13500	5
2	14228	4
3	26000	2
4	92000	3
...
COPY "Bargain"."Manufacturer" ("Manufacturer_name", "Production_volume") FROM stdin;
Bruh   234824
McDonalds   567908
YeahIMN   156400
Hypixel   154535
...
COPY "Bargain"."Bureau" ("Bureau_name", "Employees_amount") FROM stdin;
NibbaTrades   5
TPINC   12
Iasked   3
JojoTrade   24
...
COPY "Bargain"."Product" ("ID_product", "Expiration_date", "Date_of_manufacture", "Amount", "FK_Manufacturer_name") FROM stdin;
1   2026-01-01  2020-02-26  12432   WhoTF
2   2025-09-30  2019-09-30  13224   Bruh
3   2020-03-20  2019-12-20  101  Hypixel
4   2022-10-10  2018-06-12  2345  McDonalds
5   2024-09-21  2016-09-21  8    YeahIMN
\.



COPY "Bargain"."Buy_contract" ("ID_buy_contract", "FK_ID_broker", "FK_ID_client", "Buy_date", "Amount_of_bought_product", "Buy_price", "Terms_of_purchase", "FK_ID_deal") FROM stdin;
...
COPY "Bargain"."Sale_contract" ("ID_contract_to_sale", "FK_ID_broker", "FK_ID_client", "Sale_date", "Amount_of_sold_product", "Sale_price", "Terms_of_sale", "FK_ID_deal") FROM stdin;
...
COPY "Bargain"."Client" ("ID_client", "Client_name") FROM stdin;
1   Danich
2   Esno
3   Ilya
4   Igor
...
ALTER TABLE ONLY "Bargain"."Broker"
    ADD CONSTRAINT "FK_Bureau_name" FOREIGN KEY ("FK_Bureau_name") REFERENCES "Bargain"."Bureau"("Bureau_name") ON UPDATE RESTRICT ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;
