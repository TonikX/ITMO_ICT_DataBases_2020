...
CREATE TABLE "Clinic"."Medical_book" (
    ...
    "Owner_telephone" integer  NOT NULL,
...
CREATE TABLE "Clinic"."Room" (
    ...
    "responsible_telephone" integer NOT NULL,
    "inner_telephone" integer NOT NULL
);
...
INSERT INTO "Clinic"."Room" (ID_room, Room_num, Room_working_time, Responsible_name, responsible_telephone, inner_telephone) VALUES (1, 21, 'Anton Igorevich Govorov', 89152283317, 256987);
INSERT INTO "Clinic"."Room" (ID_room, Room_num, Room_working_time, Responsible_name, responsible_telephone, inner_telephone) VALUES (2, 22, 'Anton Igorevich Govorov', 89152283317, 145897);
INSERT INTO "Clinic"."Room" (ID_room, Room_num, Room_working_time, Responsible_name, responsible_telephone, inner_telephone) VALUES (3, 23, 'Anton Igorevich Govorov', 89152283317, 124536);
INSERT INTO "Clinic"."Room" (ID_room, Room_num, Room_working_time, Responsible_name, responsible_telephone, inner_telephone) VALUES (4, 24, 'Anton Igorevich Govorov', 89152283317, 145896);
INSERT INTO "Clinic"."Room" (ID_room, Room_num, Room_working_time, Responsible_name, responsible_telephone, inner_telephone) VALUES (5, 25, 'Anton Igorevich Govorov', 89152283317, 147859);
...
ALTER TABLE ONLY "Clinic"."Room"
    ADD CONSTRAINT "Room_pkey" PRIMARY KEY ("Bureau_name");
