...
[Практические работы](https://drive.google.com/drive/folders/1-3aTFWuXmNzJa2e90lXYdU8fLEfo-FZU?usp=sharing) - задания, которые необходимо выполнить перед выполнением лабораторной работы для того, чтобы освоить тему.
...
[SQL или NoSQL — вот в чём вопрос](https://habr.com/ru/company/ruvds/blog/324936/)

[MySQL и MongoDB — когда и что лучше использовать](https://habr.com/ru/post/322532/)

[Как работают NoSQL базы: документ-ориентированные типа MongoDB](https://youtu.be/7_hcfx2VDWE)

#### Практическая часть

Текст практической части работы доступен тут:

[Часть 1](https://drive.google.com/file/d/1_yECb6yInYm46NR5CD3ynTQn2Nw849gx/view?usp=sharing)

[Часть 2](https://drive.google.com/file/d/1n0_T-M3JoS_ltEx6IvwQGkr_LmOX6EOC/view?usp=sharing)

#### Лабораторная часть

[текст лабораторной работы](https://drive.google.com/file/d/11-1bRAa4GMo_zpT-DrdkqkmbBzO2bwEW/view?usp=sharing)

Вариант Вы можете взять свой из ЛР №2 или взять из текста ЛР, в соответствии с Вашим порядковым номерм в журнале.

Очет выполняется в соответствии с инструкциями в тексте работ. Отчет высылается на antongovorov@gmail.com. Шаблон темы письма "ИТМО ИКТ Номер_группы Лабораторная_и_номер ФИО". Пример: "ИТМО ИКТ К3340 Лабораторная работа №1 Филимонов Филипп Филиппович". 

### Сдача работы №6

Полученную модель, код и отчет залить в папку этого репозитория **students/группа/laboratory_works/фамилия_имя/laboratory_work_6**. Инструкция о загрузке работы ниже. Не забывайте о файле гитигнор.
На гит должен быть загружен пдф файл с отчетом, файл с запросами. Для каждого запроса в файле должен быть написан комментарий с описанием того, что делает запрос. Как делать пул реквест описано в разделе **Сдача работ**
